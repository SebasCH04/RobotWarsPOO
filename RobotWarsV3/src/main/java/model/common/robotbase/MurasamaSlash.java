...
public class MurasamaSlash extends Weapon{
    ...
    protected MurasamaSlash(int pSpeed) {
        super(pSpeed);
        this.spriteL1 = new ImageIcon("C:/Users/sebas/eclipse-workspace/RobotWarsV3/src/main/java/images/SSL1.png").getImage();
        this.spriteL2 = new ImageIcon("C:/Users/sebas/eclipse-workspace/RobotWarsV3/src/main/java/images/SSL2.png").getImage();
        this.spriteL3 = new ImageIcon("C:/Users/sebas/eclipse-workspace/RobotWarsV3/src/main/java/images/SSL3.png").getImage();
        this.spriteR1 = new ImageIcon("C:/Users/sebas/eclipse-workspace/RobotWarsV3/src/main/java/images/SSR1.png").getImage();
        this.spriteR2 = new ImageIcon("C:/Users/sebas/eclipse-workspace/RobotWarsV3/src/main/java/images/SSR2.png").getImage();
        this.spriteR3 = new ImageIcon("C:/Users/sebas/eclipse-workspace/RobotWarsV3/src/main/java/images/SSR3.png").getImage();

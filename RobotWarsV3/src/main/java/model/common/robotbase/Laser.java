...
public class Laser extends Weapon{
    ...
    protected Laser(int pSpeed, ORIENTATION pORIENTATION, int pPosX, int pPosY) {
        ...
        if(pORIENTATION == EAST || pORIENTATION == WEST){
            this.laserImage = new ImageIcon("C:/Users/sebas/eclipse-workspace/RobotWarsV3/src/main/java/images/laser1.png").getImage();
        }
        else if(pORIENTATION == NORTH || pORIENTATION == SOUTH){
            this.laserImage = new ImageIcon("C:/Users/sebas/eclipse-workspace/RobotWarsV3/src/main/java/images/laser2.png").getImage();
        }
